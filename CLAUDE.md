...
| File | Lines | Purpose |
|------|-------|---------|
| `config.rs` | 1032 | Constants, types, CostTracker, utility functions, 58 tests |
...
| `modes/premortem.rs` | 217 | Pre-mortem: assume failure, work backward |
| `modes/forecast.rs` | 218 | Superforecasting: probability estimates + reconciliation |
