...
| File | Lines | Purpose |
|------|-------|---------|
| `config.rs` | 891 | Constants, types, CostTracker, utility functions, 58 tests |
| `api.rs` | 1302 | HTTP clients, SSE streaming, parallel queries, retry, fallback |
...
| `admin.rs` | 449 | Stats, sessions, view, search |
